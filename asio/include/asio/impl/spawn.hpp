        ...
        spawn_launcher<Executor>(
          basic_yield_context<Executor>(
            default_spawned_thread_type::spawn(
              spawn_entry_point<Executor,
                typename decay<F>::type, typename decay<Handler>::type>(
